			...
			<div className='w-full max-w-7xl'>
				...
				<div className='bg-black/30 backdrop-blur-sm rounded-xl p-6 mb-8'>
					<div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
						...
						<select
							className='bg-black border border-[#24df9c]/30 rounded-lg p-3 text-white'
							value={priceFilter}
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
					{[1, 2, 3, 4, 5, 6].map((index) => (
						<div
							key={index}
							className='bg-black/20 backdrop-blur-sm border border-[#24df9c]/30 rounded-xl overflow-hidden hover:border-[#24df9c] transition-all'
						>
				...
				<div className='mt-12'>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
						{[1].map((index) => (
							<div
								key={index}
								className='bg-black/20 backdrop-blur-sm border border-[#24df9c]/30 rounded-xl overflow-hidden'
							>
								<div className='aspect-square relative'>
									<img src='/assets/robo3.png' alt='Listed Player NFT' className='w-full h-full object-cover' />
									<div className='absolute top-2 right-2 bg-[#24df9c] text-black px-2 py-1 rounded-lg text-sm font-bold'>
										#0789
									</div>
								</div>
